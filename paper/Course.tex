...
\item внутренность конуса непуста: $int K \ne \varnothing$ (или, что эквивалентно, $K - K = \mathbb{R}^n$).
\end{enumerate}
...
Здесь и далее через $int X$ будем обозначать внутренность множества $X$.
...
Введём отношение частичного порядка $\ge^K$ на $K$: $x \ge^K y$ тогда и только тогда, когда $x - y \in K$.
...
Иногда для описания некоторого лица $F$ конуса $K$ достаточно взять один вектор из $F$. Обозначим через $ri F$ относительную внутренность   множества $F$. (см. ДОБАВИТЬ ССЫЛКУ).
...
Таким образом, экстремальные лучи --- это одномерные лица конуса. Простейший пример полиэдрального конуса --- это положительный ортант $\mathbb{R}^n_+ = \{ (\xi_1, \dots, \xi_n)^R \ | \ \xi_i \ge 0 \text{ для любого $1 \le i \le n$} \}$.
...
$A$ называется $K$-положительной, если $A(K \setminus \{ 0\}) \subseteq K$.
...
По конусу $K$ и матрицы $A$, его сохраняющей, можно определить четыре графа. Рассмотрим два лица $F, G$ конуса $K$. Будем говорить, что от $F$ до $G$ идёт $\mathcal{P}$-ребро, если $G \subseteq \Phi(AF)$, и $\mathcal{I}$-ребро, если $G \subseteq \Phi((I + A)F)$, где $I$ --- единичная матрица подходящей размерности. Заметим, что если от $F$ до $G$ идёт $\mathcal{P}$-ребро, то идёт и $\mathcal{I}$-ребро, так как $\Phi(AF) \subseteq \Phi((I + A)F)$ (ДОКАЗАТЬ).

\begin{definition}
$(\mathcal{E}, \mathcal{P}(A, K))$ --- граф, вершинами которого являются его экстремальные лучи, а рёбрами --- все $\mathcal{P}$-рёбра.

Аналогично определяются $(\mathcal{E}, \mathcal{I}(A, K))$, $(\mathcal{F}, \mathcal{P}(A, K))$, $(\mathcal{F}, \mathcal{I}(A, K))$: если на первом месте стоит $\mathcal{E}$, то вершинами являются все экстремальные лучи конуса, а если $\mathcal{F}$, то все его лица; если на втором месте стоит $\mathcal{P}$, то рёбрами являются все $\mathcal{P}$-рёбра, а если $\mathcal{I}$, то все его $\mathcal{I}$-рёбра.
\end{definition}
