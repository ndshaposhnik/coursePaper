...
Для конкретных $a, b$ необходимо искать самый верхний подходящий случай:
\begin{enumerate}
	\item $a \ \vdots \ 4, b \centernot \vdots 2$. Тогда $P(4, a, b) = P(4, b)$.

	\item $a \centernot \vdots 2, b \ \vdots \ 4$, или $0 \centernot \equiv a \equiv b \pmod 4$, или $a \centernot\vdots 2, b \ge P(4, a)$, или $a \centernot\vdots 2, b \equiv 2 \pmod 4$, $b \ge 2a$. Тогда $P(4, a, b) = P(4, a)$.
	
	\item $a \centernot\vdots 2, b \equiv 2 \pmod 4, b < 2a$ или $a \equiv 2 \pmod 4, b \centernot \vdots 2$. Тогда $P(4, a, b) = a + b - 3$.
	
	\item $a, b \centernot \vdots 2$, $a + b \ \vdots \ 4, b < 3a - 3$. Тогда \begin{equation*}
		P(4, a, b) = \begin{cases}
...
Докажем случай $a \centernot\vdots 2, b \ge P(4, a)$. Заметим, что используя в линейной комбинации число $b$, нельзя получить сумму, меньшую $P(a, b)$, а используя только числа $a$ и $b$ можно получить любое число, не меньшее $P(4, a)$, что доказывает утверждение в этом случае.

Разберём случай $a \centernot\vdots 2, b \equiv 2 \pmod 4$, $b \ge 2a$. Рассмотрим массив $M$. Известно, что $M[0] = 0$, $M[a \ rem \ 4] = a$. Найдём $M[2]$ и $M[4 - a \ rem \ 4]$. Несложно видеть, что в обоих случаях, в силу неравенства $b \ge 2a$, выгоднее использовать  $2a$ вместо $b$. Следовательно, $M[2] = 2a$ и $M[4 - a \ rem \ 4] = 3a$. Значит, по утверждению \ref{algorithm2:lemma1} имеем $P(4, a, b) = 3a - 3 = P(4, a)$.

Перейдём к следующему случаю: $a \centernot\vdots 2, b \equiv 2 \pmod 4, b < 2a$. В отличие от предыдущего, в этот раз выгоднее использовать $b$ вместо $2a$. Таким образом, $M[2] = b$, $M[a \ rem \ 4 = a$, $M[4 - a \ rem \ 4] = a + b$. Следовательно, по утверждению \ref{algorithm2:lemma1}, $P(4, a, b) = a + b - 3$.

В случае $a \equiv 2 \pmod 4, b \centernot \vdots 2$ массив $M$ принимает следующий вид: $M[2] = a$, $M[b \ rem \ 4] = b$, $M[4 - b \ rem \ 4] = a + b$. Значит, $P(4, a, b) = a + b - 3$ (по утверждению \ref{algorithm2:lemma1}).
